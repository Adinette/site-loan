            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Icônes réseaux sociaux</h2>
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="/linkedin" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">Vos données sont protégées grâce à un système de cryptage avancé.
                    </span>
                </div>
