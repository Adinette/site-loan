    ...
    return (
        <div id='faq' className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">FAQ (Foire aux questions)</h2>
                <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                    <div>
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Feel free to contact us and we'll help you out as soon as we can.</p>
                        </div>
                    </div>
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Find out more information by reading the license.</p>
                        </div>
                        <div>
                            <div className="mb-10">
                                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                ...
                                <p className="text-gray-500 dark:text-gray-400">The free updates that will be provided is based on the roadmap that we have laid out for this project. It is also possible that we will provide extra updates outside of the roadmap as well.</p>
                            </div>
                        </div>
                    </div>
                </div>
